...
<main class="p-page-about">
  ...
  <section class="p-sect-philosophy p-page-about__philosophy">
    <!-- .l-content -->
    <div class="p-sect-philosophy__inner l-content l-content--sub">
  ...
  <section class="p-sect-ceo p-page-about__ceo">
    <!-- .l-content -->
    <div class="p-sect-ceo__inner l-content l-content--sub">
  ...
  <section class="p-sect-service p-page-about__service">
    <!-- .l-content -->
    <div class="p-sect-service__inner l-content l-content--sub">
  ...
  <section class="p-sect-company p-page-about__company">
    <!-- .l-content -->
    <div class="p-sect-company__inner l-content l-content--sub">
