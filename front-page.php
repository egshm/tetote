...
<main class="p-page-top">
  ...
  <section class="p-sect-mission p-page-top__mission">
    <!-- .l-content -->
    <div class="p-sect-mission__inner l-content js-inview u-inview-up">
  ...
  <section class="p-sect-staff p-page-top__staff">
    <!-- .l-content -->
    <div class="p-sect-staff__inner l-content js-inview u-inview-up">
      <!-- .c-heading-lv2 -->
  ...
  <section class="p-sect-benefits p-page-top__benefits">
    <!-- .l-content -->
    <div class="p-sect-benefits__inner l-content js-inview u-inview-up">
      <!-- .c-heading-lv2 -->
  ...
  <section class="p-sect-blog p-page-top__blog">
    <!-- .l-content -->
    <div class="p-sect-blog__inner l-content js-inview u-inview-up">
      <!-- .c-heading-lv2 -->
      <hgroup class="c-heading-lv2">
  ...
  <section class="p-sect-recruit p-page-top__recruit">
    <!-- .l-content -->
    <div class="p-sect-recruit__inner l-content js-inview u-inview-up">
      <!-- .c-heading-lv2 -->
