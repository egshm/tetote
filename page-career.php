...
<main class="p-page-career">
  ...
  <section class="p-sect-career p-page-career__career">
    ...
    <div class="p-sect-career__inner l-inner-sub">
      ...
      <p class="p-sect-career__text">
        <span class="u-text-upper">Tetote</span>は、コンサルタントのキャリアパスを支えるために、以下の独自の研修制度を設けています。
      </p>
      <ul class="p-sect-career__list">
        <li class="p-sect-career__item">
          <h3 class="p-sect-career__item-title">1. ケーススタディ研修</h3>
          <p class="p-sect-career__text">
            <span class="u-text-upper">Tetote</span>の過去のプロジェクト事例を基にしたケーススタディ研修を実施しています。<br>
        ...
        <li class="p-sect-career__item">
          ...
          <p class="p-sect-career__text">
            <span class="u-text-upper">Tetote</span>は、クライアントとの信頼関係構築を重視しています。<br>
        ...
        <li class="p-sect-career__item">
          ...
          <p class="p-sect-career__text">
            ...
            <span class="u-text-upper">Tetote</span>は、幅広い分野の知識を持つコンサルタントを育成し、クライアントに最適なソリューションを提供できるようにしています。
          </p>
        </li>
        <li class="p-sect-career__item">
          ...
          <p class="p-sect-career__text">
            ...
            <span class="u-text-upper">Tetote</span>は、将来的にマネジメント層を担うコンサルタントを育成し、組織全体の成長を促進しています。
          </p>
        </li>
        <li class="p-sect-career__item">
          ...
          <p class="p-sect-career__text">
            ...
            <span class="u-text-upper">Tetote</span>は、最新の知識やスキルを習得し、常に成長し続けるコンサルタントを育成します。
          </p>
        </li>
      </ul>
    </div>
