...
<main class="p-page-details">
  ...
  <div class="p-fv-sub p-page-details__fv">
    ...
    <div class="p-fv-sub__img-wrap" aria-hidden="true">
      <picture>
        <source
          srcset="<?php echo esc_url(get_theme_file_uri("images/fv-details_sp.webp")); ?>"
          type="image/webp"
          media="(max-width: 767.98px)"
        >
        <source
          srcset="<?php echo esc_url(get_theme_file_uri("images/fv-details_sp.jpg")); ?>"
          media="(max-width: 767.98px)"
        >
        <source
          srcset="<?php echo esc_url(get_theme_file_uri('images/fv-details.webp')); ?>"
          type="image/webp"
        >
        <source
          srcset="<?php echo esc_url(get_theme_file_uri("images/fv-details.jpg")); ?>"
        >
        <img
  ...
  <section class="p-sect-details p-page-details__details">
    <!-- .l-content -->
    <div class="p-sect-details__inner l-content l-content--sub">
