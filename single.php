...
<main class="p-page-blog-detail">
  ...
  <!-- .l-content -->
  <div class="p-page-blog-detail__inner l-content l-content--sub">
  ...
  <?php if ($prev_post || $next_post): ?>
    <!-- .p-post-navi -->
    <nav class="p-post-navi p-page-blog-detail__post-navi" aria-label="記事の前後ナビゲーション">
      <ul class="p-post-navi__inner">
        <?php if ($prev_post): ?>
          <li class="p-post-navi__prev">
            <!-- 前の記事のURL -->
            <a href="<?php echo esc_url(get_permalink($prev_post->ID)); ?>" class="p-post-navi__link">
              <div class="p-post-navi__body">
                <div class="p-post-navi__title-wrap">
                  <p class="p-post-navi__title"><?php echo esc_html(get_the_title($prev_post->ID)); ?></p>
                </div>
                <time class="p-post-navi__date" datetime="<?php echo esc_attr(get_the_date('Y-m-d', $prev_post->ID)); ?>">
                  <?php echo esc_html(get_the_date('Y.m.d', $prev_post->ID)); ?>
                </time>
              </div>
              <!-- .c-btn-icon -->
              <div class="c-btn-icon p-post-navi__btn" aria-hidden="true">
        ...
        <?php if ($next_post): ?>
          <li class="p-post-navi__next">
            <!-- 次の記事のURL -->
            <a href="<?php echo esc_url(get_permalink($next_post->ID)); ?>" class="p-post-navi__link">
              <div class="p-post-navi__body">
                <div class="p-post-navi__title-wrap">
                  <p class="p-post-navi__title"><?php echo esc_html(get_the_title($next_post->ID)); ?></p>
                </div>
                <time class="p-post-navi__date" datetime="<?php echo esc_attr(get_the_date('Y-m-d', $next_post->ID)); ?>">
